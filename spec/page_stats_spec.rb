...
RSpec.describe PageStats do
  ...
  #       stub_request(:post, MockPageStats.content_url).with(MockPageStats.mock_body_headers).to_return(MockPageStats.mock_return)
  #       allow(ContentPage).to receive(:new).with(any_args) { ContentPage.new }
  #       expect(subject.reading_level_data).to eq(MockPageStats.data)
  #     end
  #   end
  # end
